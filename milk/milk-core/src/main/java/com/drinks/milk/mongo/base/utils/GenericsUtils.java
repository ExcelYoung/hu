package com.drinks.milk.mongo.base.utils;
        ...
        if (obj == null) {
            ...
            for(int i = 0; i < fieldList.size(); ++i) {
                ...
                try {
                    ...
                    if (value != null && field.getAnnotation(Id.class) == null && !"serialversionuid".equals(field.getName().toLowerCase()) && field.getAnnotation(Transient.class) == null) {
                        if (isFirst) {
